/**
 * Builds the request body for a given category of model.
 * @param {string} category - The category of model (e.g. "sap-abap", "claude-anthropic", "openai-gpt", "custom")
 ...
 * @returns {Object} The request body for the model
 */
...
/**
 * Builds the request body for a SAP ABAP model.
 * @param {Array} messages - The messages to send to the model
 * @param {string} modelKey - The key of the model to use
 * @param {Object} params - The parameters for the model
 * @param {boolean} [streaming=false] - Whether to stream the response
...
/**
 * Builds the request body for a Claude model.
 * @param {Array} messages - The messages to send to the model
 * @param {string} modelKey - The key of the model to use
 * @param {Object} params - The parameters for the model
 * @param {boolean} [streaming=false] - Whether to stream the response
 * @returns {Object} The request body for the model
 */
function buildClaudeRequest(messages, modelKey, params, _streaming) {
...
/**
 * Builds the request body for an OpenAI model.
 * @param {Array} messages - The messages to send to the model
 * @param {string} modelKey - The key of the model to use
 * @param {Object} params - The parameters for the model
 * @param {boolean} [streaming=false] - Whether to stream the response
...
/**
 * Parses the response from a model.
 * @param {string} category - The category of model (e.g. "sap-abap", "claude-anthropic", "openai-gpt", "custom")
...
/**
 * Parses the response from a SAP ABAP model.
 * @param {Object} response - The response from the model
 * @returns {string} The parsed response
 */
...
/**
 * Parses the response from a Claude model.
 * @param {Object} response - The response from the model
 * @returns {string} The parsed response
 */
...
/**
 * Parses the response from an OpenAI model.
 * @param {Object} response - The response from the model
 * @returns {string} The parsed response
 */
...
/**
 * Parses a stream chunk from a model.
 * @param {string} category - The category of model (e.g. "sap-abap", "claude-anthropic", "openai-gpt", "custom")
 * @param {string} data - The stream chunk data
 * @returns {string} The parsed stream chunk
 */
...
/**
 * Parses a stream chunk from a SAP ABAP model.
 * @param {string} data - The stream chunk data
 * @returns {string} The parsed stream chunk
 */
function parseSAPABAPStreamChunk(data) {
  if (
    data.final_result &&
    data.final_result.choices &&
    data.final_result.choices[0]
  ) {
...
/**
 * Parses a stream chunk from a Claude model.
 * @param {string} data - The stream chunk data
 * @returns {string} The parsed stream chunk
 */
...
/**
 * Parses a stream chunk from an OpenAI model.
 * @param {string} data - The stream chunk data
 * @returns {string} The parsed stream chunk
 */
...
/**
 * Gets the headers for a model category.
 * @param {string} category - The category of model (e.g. "sap-abap", "claude-anthropic", "openai-gpt", "custom")
 * @param {string} token - The authentication token
 * @param {string} resourceGroup - The resource group (optional)
 * @returns {Object} The headers for the model category
 */
